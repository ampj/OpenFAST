...
! This code was generated by Write_ChckOutLst.m at 04-Jan-2014 12:13:30.
  ...
  INTEGER(IntKi), PARAMETER      :: M1N1Axi   =    1
   ...
   INTEGER(IntKi), PARAMETER      :: RnSIxi    = 4033   ! RAINEY - X coordinate of free surface/member intersection 
   INTEGER(IntKi), PARAMETER      :: RnSIyi    = 4034   ! RAINEY - Y coordinate of free surface/member intersection
   INTEGER(IntKi), PARAMETER      :: RnSIzi    = 4035   ! RAINEY - Z coordinate of free surface/member intersection
   INTEGER(IntKi), PARAMETER      :: RnSIFxi   = 4036   ! RAINEY - X component of force at free surface/member intersection
   INTEGER(IntKi), PARAMETER      :: RnSIFyi   = 4037   ! RAINEY - Y component of force at free surface/member intersection
   INTEGER(IntKi), PARAMETER      :: RnSIFzi   = 4038   ! RAINEY - Z component of force at free surface/member intersection
...
! This code was generated by Write_ChckOutLst.m at 04-Jan-2014 12:13:30.
 ...
 CHARACTER(OutStrLenM1), PARAMETER  :: ValidParamAry(4038) =  (/ &                  ! This lists the names of the allowed parameters, which must be sorted alphabetically
                               ...
                               "M9N9VYI  ","M9N9VZI  ","RNSIFXI  ","RNSIFYI  ","RNSIFZI  ","RNSIXI   ","RNSIYI   ","RNSIZI   "/)
   INTEGER(IntKi), PARAMETER :: ParamIndxAry(4038) =  (/ &                            ! This lists the index into AllOuts(:) of the allowed parameters ValidParamAry(:)
                                    J1Axi ,     J1Ayi ,     J1Azi ,    J1DynP ,   J1FAMxi ,   J1FAMyi ,   J1FAMzi ,   J1FBFxi ,   J1FBFyi ,   J1FBFzi , &
                                   J1FBxi ,    J1FByi ,    J1FBzi ,    J1FDxi ,    J1FDyi ,    J1FDzi ,    J1FIxi ,    J1FIyi ,    J1FIzi ,   J1MBFxi , &
                                  J1MBFyi ,   J1MBFzi ,    J1MBxi ,    J1MByi ,    J1MBzi ,   J1STAxi ,   J1STAyi ,   J1STAzi ,   J1STVxi ,   J1STVyi , &
                                  J1STVzi ,     J1Vxi ,     J1Vyi ,     J1Vzi ,     J2Axi ,     J2Ayi ,     J2Azi ,    J2DynP ,   J2FAMxi ,   J2FAMyi , &
                                ...
                                M9N9FAFxi , M9N9FAFyi , M9N9FAFzi , M9N9FAGxi , M9N9FAGyi , M9N9FAGzi , M9N9FAMxi , M9N9FAMyi , M9N9FAMzi ,  M9N9FAxi , &
                                 ...
                                 M9N9MBxi ,  M9N9MByi ,  M9N9MBzi , M9N9STAxi , M9N9STAyi , M9N9STAzi , M9N9STVxi , M9N9STVyi , M9N9STVzi ,   M9N9Vxi , &
                                  M9N9Vyi ,   M9N9Vzi ,   RnSIFxi ,   RnSIFyi ,   RnSIFzi ,    RnSIxi ,    RnSIyi ,    RnSIzi /)
   CHARACTER(ChanLen), PARAMETER :: ParamUnitsAry(4038) =  (/ &                     ! This lists the units corresponding to the allowed parameters
...
!---------------------------------------------------------------------------------------------------- 
   ...
   IF ( p%NumOuts > 0 ) THEN
    ...
    ! Map position where the Rainey surface intersection force is applied

    AllOuts(RnSIxi) = m%RnSIPos(1)
    AllOuts(RnSIyi) = m%RnSIPos(2)
    AllOuts(RnSIzi) = m%RnSIPos(3)   

    ! Map the Rainey surface intersection force
    
    AllOuts(RnSIFxi) = m%RnSIF(1)
    AllOuts(RnSIFyi) = m%RnSIF(2)
    AllOuts(RnSIFzi) = m%RnSIF(3)
